...
namespace Poseidon.Infrastructure.ClientDx
{
    ...
    public partial class FrmGroupAdd : BaseSingleForm
    {
        ...
        {
            var groups = BusinessFactory<GroupBusiness>.Instance.FindByModule(InfrastructureConstant.ModuleName);
            this.bsGroup.DataSource = groups.ToList();

            this.txtModule.Text = InfrastructureConstant.ModuleName;
        ...
        private void btnConfirm_Click(object sender, EventArgs e)
        {
            ...
            {
                Logger.Instance.Exception("保存分组失败", pe);
